...
```kotlin
-8<- "demo-app/src/commonMain/kotlin/org/maplibre/compose/demoapp/docs/Interaction.kt:gesture-settings"
```
...
```kotlin
-8<- "demo-app/src/commonMain/kotlin/org/maplibre/compose/demoapp/docs/Interaction.kt:ornament-settings"
```
...
```kotlin
-8<- "demo-app/src/commonMain/kotlin/org/maplibre/compose/demoapp/docs/Interaction.kt:camera"
```
...
```kotlin
-8<- "demo-app/src/commonMain/kotlin/org/maplibre/compose/demoapp/docs/Interaction.kt:camera-animate"
```
...
```kotlin
-8<- "demo-app/src/commonMain/kotlin/org/maplibre/compose/demoapp/docs/Interaction.kt:click-listeners"
```
