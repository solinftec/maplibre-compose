...
```kotlin
-8<- "demo-app/src/commonMain/kotlin/org/maplibre/maplibrecompose/demoapp/docs/Layers.kt:simple"
```
...
```kotlin
-8<- "demo-app/src/commonMain/kotlin/org/maplibre/maplibrecompose/demoapp/docs/Layers.kt:amtrak-1"
```
...
```kotlin
-8<- "demo-app/src/commonMain/kotlin/org/maplibre/maplibrecompose/demoapp/docs/Layers.kt:amtrak-2"
```
...
```kotlin
-8<- "demo-app/src/commonMain/kotlin/org/maplibre/maplibrecompose/demoapp/docs/Layers.kt:anchors"
```
...
```kotlin
-8<- "demo-app/src/commonMain/kotlin/org/maplibre/maplibrecompose/demoapp/docs/Layers.kt:interaction"
```
