...
import org.maplibre.compose.compose.offline.OfflinePackDefinition
import org.maplibre.compose.compose.offline.toMLNOfflineRegion
import org.maplibre.compose.compose.offline.toOfflinePackDefinition
...
class TilePackDefinitionTest {
  ...
  fun convertTilePyramid() {
    ...
    assert(noMax.toMLNOfflineRegion().toOfflinePackDefinition() == noMax)
    ...
    assert(minMax.toMLNOfflineRegion().toOfflinePackDefinition() == minMax)
  }
