 ...
 *   [[LineLayer][org.maplibre.][org.maplibre.maplibrecompose.compose.layer.LineLayer]s that specify a `gradient`.
 */
@Immutable
public data class GeoJsonOptions(
  ...
  public data class ClusterPropertyAggregator<T : ExpressionValue>(
     ...
     * [org.maplibre.maplibrecompose.expressions.dsl.Feature.accumulated] will return the value
